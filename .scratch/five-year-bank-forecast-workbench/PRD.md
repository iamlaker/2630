...
- Rule maintenance is embedded as the fourth tab and reuses the three-pane workbench shell; administrators can log in and maintain rules inside the tab. Read APIs are available to ordinary users; mutation, rescan, activation, and deactivation remain administrator-only.
